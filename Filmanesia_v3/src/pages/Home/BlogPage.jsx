...
const ARTICLES = [
  ...
  { category: 'Film Jepang', title: 'Film Jepang Terbaik dengan Cerita yang Membekas', excerpt: 'Rekomendasi cerita Jepang yang tenang, unik, dan manusiawi untuk menemani waktu santai.', date: '22 September 2026', image: '/preview.png', alt: 'Poster film Jepang dari TMDB', href: '/blog/film-jepang-terbaik' },
  { category: 'Film Bioskop', title: 'Film Bioskop Terbaru yang Layak Dinantikan', excerpt: 'Pilihan film layar besar dengan visual, suara, dan skala cerita yang menarik.', date: '22 September 2026', image: '/preview.png', alt: 'Poster film bioskop terbaru dari TMDB', href: '/blog/film-bioskop-terbaru' },
];
