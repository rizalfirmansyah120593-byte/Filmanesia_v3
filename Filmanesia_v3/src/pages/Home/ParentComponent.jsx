        ...
        {location.pathname === '/' && <footer className="bg-[#0a0c12]">
          ...
          <div className="max-w-5xl mx-auto px-6 py-6 flex flex-col sm:flex-row items-center justify-between gap-4 text-[11px] text-gray-600">
            ...
            <div className="flex items-center gap-4">
              ...
              <a href="https://www.dmca.com/Protection/Status.aspx?ID=204cd8cc-b62c-4f4a-aa8b-939824095655" title="DMCA.com Protection Status" className="dmca-badge" rel="noopener noreferrer"> <img src="https://images.dmca.com/Badges/dmca_protected_sml_120m.png?ID=204cd8cc-b62c-4f4a-aa8b-939824095655" loading="lazy" width="120" height="20" alt="DMCA.com Protection Status" /></a>
            </div>
          </div>
        </footer>}
      </div>
